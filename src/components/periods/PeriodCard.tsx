...
export const PeriodCard = ({ period }: Props) => {
  ...
  return (
    <Link to="/dashboard/periods/$periodId" params={{ periodId: period.id }} className="bg-muted w-96 text-muted-foreground px-10 py-8 rounded-2xl space-y-5 hover:ring transition-all duration-300 hover:-translate-y-2">
      {/* Header */}
