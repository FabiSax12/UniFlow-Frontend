    ...
    <div className="max-w-lg w-full mx-auto  bg-[var(--card)] rounded-lg shadow-md p-6 shadow-md p-6 absolute top-27 left-1/2 transform -translate-x-1/2" >
      ...
      <div className="space-y-4" >
        ...
        {/* <button
          ...
          className="w-full flex items-center justify-center px-6 py-3 border border-gray-300 rounded-md shadow-sm bg-gray-900 text-white hover:bg-gray-800 transition-all"
        >
